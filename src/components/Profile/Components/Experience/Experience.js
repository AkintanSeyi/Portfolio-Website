...
const Experience = () => {
  ...
  <span  className='companyname_style' style={{textAlign : "center" ,  borderBottom : "2.5px solid white", width : "fit-content"}} >organizations worked with</span>
...

{
  ...
  return (  <Style.About_Orgaization_Box_Inner_Box   key={index}  >
...
<Style.About_Footer_Box_Button  onClick={() => navigate(-1)}  className='companyname_style'  >
GO BACK
</Style.About_Footer_Box_Button>

<Style.About_Footer_Box_Button   onClick={() => navigate("/skills")}  className='companyname_style' >
SKILLS ACQUIRED
</Style.About_Footer_Box_Button>
