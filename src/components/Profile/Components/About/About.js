...
<span  className='companyname_style' style={{textAlign : "center" ,  borderBottom : "2.5px solid white", width : "fit-content"}} > About Me  </span>
...
<Style.About_Paragraph   data-aos="fade-left" >
  ...
  <Style.About_Box   >
  <Style.About_Box_Paragraph  className='about_box'   onClick={() => navigate("/skills")}  >
  <Style.About_Box_Paragraph_Span_Certificate  >
  Skills Acquired
        </Style.About_Box_Paragraph_Span_Certificate>
    </Style.About_Box_Paragraph>
